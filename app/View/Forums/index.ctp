					...
					<tr>
						...
						<td>
							<?php 
								echo $this->Html->link('<h4>'.$forum['Forum']['name'].'</h4>',
									array('controller'=>'topics', 'action'=>'index', $forum['Forum']['id']), array('escape'=>false));
							?>
						</td>
						...
						<td>
						  <?php 
							  ...
							  {
							  	$post = $forum['Post'][0];
							  	echo $this->Html->link($post['Topic']['name'],array('controller'=>'topics', 'action'=>'view', $post['Topic']['id']));
							  	echo '&nbsp;';
